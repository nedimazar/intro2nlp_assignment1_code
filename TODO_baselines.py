...
if __name__ == "__main__":
    ...
    majority_accuracy_dev, majority_predictions = majority_baseline(
        train_sentences, train_labels, dev_sentences, dev_labels
    )

    majority_accuracy_test, majority_predictions = majority_baseline(
    ...
    random_accuracy_dev, majority_predictions = random_baseline(
        train_sentences, train_labels, dev_sentences, dev_labels
    )

    random_accuracy_test, majority_predictions = random_baseline(
        train_sentences, train_labels, test_sentences, test_labels
    )
